...
<div class="box">
  <div class="enterprise">
    <div class="ent_title"><img src="/dswx/Public/Home/image/6_03.jpg" ><b>企业注册</b></div>
    <div class="clear"></div>
	<font color="red" size="2px">注意：所有项均为必填项</font>
    <ul>
	  <li class="ys_a"><b>用 户 名：</b><input type="text" nhame="company_username" id="company_username" class="ent_1" placeholder="用户名 "/></input> </li>
	  <li class="ys_a"><b>用户密码：</b><input type="password" class="ent_1" id="company_pass" name="company_pass" placeholder="设置密码 "/></input></li>
      <li class="ys_a"><b>确认密码：</b><input type="password" class="ent_1" id="company_pass1" name="company_pass1" placeholder="密码确认 "/></input></li>
	  <li class="ys_a"><b>手 机 号：</b><input type="text" class="ent_1" name="company_phone" id="company_phone" placeholder="手机号"/></input> </li>
        <li class="ys_a"><b>电子邮箱：</b><input type="text" class="ent_1" name="company_email" id="company_email" placeholder="电子邮箱"/></input> </li>
        <li class="ys_a"><b>企 业 名：</b><input type="text" name="company_name" id="company_name" class="ent_1" placeholder="企业名 "/></input> </li>
      ...
      <table>
      <tr>
      <td><input type="radio" name="company_class" id="company_class" value="小型微利企业" class="cs1" ><b>小型微利企业</b>  </td>
      <td><input type="radio" name="company_class" id="company_class" class="cs1" value="非小型微利企业"><b>非小型微利企业</b> </td>
      </tr>
      </table>
      </li>
    </ul>
...
$("#submit-").on("click",function(){
	...
	else if(company_username.length <6 ){
		layer.msg("用户名长度大于6哦！", 2, 3);
		flag = false;
	}else if(company_name == ''){
		layer.msg("企业名没填写哦！", 2, 3);
		flag = false;
