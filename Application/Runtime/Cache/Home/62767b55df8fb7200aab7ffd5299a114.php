...
<div class="box">
  <div class="enterprise">
    ...
    <ul>
      ...
      <li><input name="user_pass" type="password" class="ent_1" id="user_pass" placeholder="密码 " /></input><a  href="<?php echo U('RetrievePassword');?>" style="float:right;">找回密码</a><?php if ($has_new){?><a href="index.php?m=&c=Login&a=first&new_reg=1">新用户注册</a><?php }?></li>
      </li>
    </ul>   
